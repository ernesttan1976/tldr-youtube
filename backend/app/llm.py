...
from .openai_client import create_openai_client, create_async_openai_client
...
async def generate_sections_and_markdown_async(
    title: str, video_id: str, url: str, transcript_minutes: str
) -> tuple[dict, str, list[SectionMd]]:
